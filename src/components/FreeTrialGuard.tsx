...
export default function FreeTrialGuard({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      {children}
      {remaining >= 0 && remaining < FREE_PAGE_LIMIT && (
